<template>
  <div class="container">
    ...
    <div class="text-left">
      <h2>
        <font-awesome-icon :icon="{ prefix: 'fa', iconName: 'terminal' }" />
        Background
      </h2>
      <p>
        ...
        magnam aliquam quaerat voluptatem. <img class="d-flex justify-content-center" src="https://images.unsplash.com/photo-1481349518771-20055b2a7b24?ixid=MXwxMjA3fDB8MHxzZWFyY2h8M3x8cmFuZG9tfGVufDB8fDB8&ixlib=rb-1.2.1&w=1000&q=80" alt="test"> Ut enim ad minima veniam, quis
      ...
      <h2>
        <font-awesome-icon :icon="{ prefix: 'fa', iconName: 'code' }" />
